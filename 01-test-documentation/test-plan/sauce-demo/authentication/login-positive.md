...
| L010 | Verify products are displayed in the product list | User is logged in | 1. Check if products are correctly displayed | Products on the products list are visible | High |
...
| L014 | Verify successful log out | User is logged in | 1. Successfully log out | User sees login page, has no access to authenticated content and is logged out | High |
