...
| L011 | Verify user cannot log in with uppercase username | User is on the login page | 1. Enter standard_user username<br>2. Enter valid password<br>3. Click Login button | User is not logged in and error message for invalid credentials is displayed | High |
| L012 | Verify user cannot log in with uppercase password | User is on the login page | 1. Enter standard_user username<br>2. Enter valid password<br>3. Click Login button | User is not logged in and error message for invalid credentials is displayed | High |
