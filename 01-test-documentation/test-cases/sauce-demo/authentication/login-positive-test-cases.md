...
| L008 | Verify user session persists after closing and reopening browser | User is on the login page | 1. Log in with valid credentials<br>2. Close browser completely<br>3. Reopen browser<br>4. Navigate to SauceDemo | User remains authenticated and is redirected to the inventory page without needing to log in again | Medium |
